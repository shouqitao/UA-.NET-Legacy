...
namespace Opc.Ua {
    ...
    public class WindowsCertificateStore : ICertificateStore {
                ...
                lock (m_lock) {
                    ...
                    try {
                        ...
                        if (hStore != IntPtr.Zero) {
                            ...
                            if (result == 0) {
                                Utils.Trace("Could not close certificate store. Error={0:X8}",
        ...
        public bool Delete(string thumbprint) {
            lock (m_lock) {
                ...
                try {
                    ...
                    CERT_CONTEXT certificate1 =
                        (CERT_CONTEXT) Marshal.PtrToStructure(pCertContext, typeof(CERT_CONTEXT));
                    CERT_CONTEXT certificate2 =
                        (CERT_CONTEXT) Marshal.PtrToStructure(pDupCertContext, typeof(CERT_CONTEXT));
        ...
        public string GetPrivateKeyFilePath(string thumbprint) {
            lock (m_lock) {
                ...
                try {
                    ...
                    CspKeyContainerInfo container =
                        GetCspKeyContainerInfo(hStore, thumbprint, m_symbolicName, m_storeType);
        ...
        public static IList<WindowsCertificateStore> EnumerateStores(
            ...
            try {
                ...
                for (uint ii = 0; ii < results.Count; ii++) {
                    ...
                    store.m_displayName = GetStoreDisplayName(store.m_storeType, store.m_serviceNameOrUserSid,
        ...
        /// </summary>
        private static string GetStoreDisplayName(WindowsStoreType storeType, string serviceNameOrUserSid,
            string storeName) {
