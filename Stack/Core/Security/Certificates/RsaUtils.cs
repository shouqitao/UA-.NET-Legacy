...
namespace Opc.Ua {
    ...
    public static class RsaUtils {
        ...
        public static byte[] Encrypt(
            ...
            ArraySegment<byte> cipherText = Encrypt(new ArraySegment<byte>(plainText), encryptingCertificate, useOaep,
        ...
        public static ArraySegment<byte> Encrypt(
            ...
            if (dataToEncrypt.Count % inputBlockSize != 0) {
                Utils.Trace("Message is not an integral multiple of the block size. Length = {0}, BlockSize = {1}.",
                    dataToEncrypt.Count, inputBlockSize);
            }
        ...
        public static byte[] Decrypt(
            ...
            ArraySegment<byte> plainText =
                Decrypt(dataToDecrypt, encryptingCertificate, useOaep, new ArraySegment<byte>(buffer));
        ...
        public static ArraySegment<byte> Decrypt(
            ...
            if (dataToDecrypt.Count % inputBlockSize != 0) {
                Utils.Trace("Message is not an integral multiple of the block size. Length = {0}, BlockSize = {1}.",
                    dataToDecrypt.Count, inputBlockSize);
            }
            ...
            // return buffers.
            return new ArraySegment<byte>(decryptedBuffer, outputBuffer.Offset,
