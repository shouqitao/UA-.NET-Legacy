...
namespace Opc.Ua {
    ...
    public static class Profiles {
        ...
        /// </summary>
        internal const string WsHttpXmlTransport_DoesNotMatchSpec =
            "http://opcfoundation.org/UA/profiles/transport/wsxml";

        /// <summary>
        /// Communicates with SOAP 1.2, WS Security and UA XML or UA Binary.
        /// </summary>
        internal const string WsHttpXmlOrBinaryTransport_DoesNotMatchSpec =
            "http://opcfoundation.org/UA/profiles/transport/wsxmlorbinary";

        /// <summary>
        /// Communicates with SOAP 1.2, WS Security and UA Binary.
        /// </summary>
        internal const string WsHttpBinaryTransport_DoesNotMatchSpec =
            "http://opcfoundation.org/UA/profiles/transport/wsbinary";
        ...
        /// Communicates with SOAP 1.2, WS Security and UA XML or UA Binary.
        /// </summary>
        public const string WsHttpXmlOrBinaryTransport =
        ...
        public static string NormalizeUri(string profileUri) {
            ...
            switch (profileUri) {
                case Profiles.UaTcpTransport_DoesNotMatchSpec: {
                    return Profiles.UaTcpTransport;
                }
                case Profiles.WsHttpXmlOrBinaryTransport_DoesNotMatchSpec: {
                    return Profiles.WsHttpXmlOrBinaryTransport;
                }
                case Profiles.WsHttpXmlTransport_DoesNotMatchSpec: {
                    return Profiles.WsHttpXmlTransport;
                }
            }
