...
namespace Opc.Ua.Export {
    ...
    public partial class UANodeSet {
        ...
        /// </summary>
        private Opc.Ua.ExpandedNodeId ImportExpandedNodeId(string source, NamespaceTable namespaceUris,
        ...
        /// </summary>
        private Opc.Ua.Export.DataTypeDefinition
            Export(Opc.Ua.DataTypeDefinition source, NamespaceTable namespaceUris) {
            if (source == null) {
                return null;
            }
        ...
        /// </summary>
        private Opc.Ua.DataTypeDefinition
            Import(Opc.Ua.Export.DataTypeDefinition source, NamespaceTable namespaceUris) {
            if (source == null) {
                return null;
            }
        ...
        private ushort ImportNamespaceIndex(ushort namespaceIndex, NamespaceTable namespaceUris) {
            ...
            // return a bad value if parameters are bad.
            if (namespaceUris == null || this.NamespaceUris == null ||
                this.NamespaceUris.Length <= namespaceIndex - 1) {
                return UInt16.MaxValue;
            }
