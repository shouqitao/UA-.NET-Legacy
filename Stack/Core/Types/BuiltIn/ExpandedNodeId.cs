...
namespace Opc.Ua {
    ...
    public class ExpandedNodeId : IComparable, IFormattable, ICloneable {
        ...
        public void Format(StringBuilder buffer) {
            if (m_nodeId != null) {
                Format(buffer, m_nodeId.Identifier, m_nodeId.IdType, m_nodeId.NamespaceIndex, m_namespaceUri,
                    m_serverIndex);
            } else {
        ...
        /// </summary>
        public static ExpandedNodeId Parse(string text, NamespaceTable currentNamespaces,
        ...
        public static NodeId Parse(string text, NamespaceTable namespaceUris) {
            ...
            if (localId == null) {
                throw ServiceResultException.Create(StatusCodes.BadNodeIdInvalid,
                    "NamespaceUri ({0}) is not in the namespace table.", nodeId.NamespaceUri);
            }
    ...
    /// </summary>
    [CollectionDataContract(Name = "ListOfExpandedNodeId", Namespace = Namespaces.OpcUaXsd,
