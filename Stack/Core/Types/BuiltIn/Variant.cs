...
namespace Opc.Ua {
    ...
    public partial struct Variant : IFormattable, ICloneable {
        ...
        private void Set(object value, TypeInfo typeInfo) {
            ...
            throw new ServiceResultException(
                StatusCodes.BadNotSupported,
                Utils.Format("Arrays of the type '{0}' cannot be stored in a Variant object.",
    ...
    public class Matrix : IFormattable, ICloneable {
        ...
        /// </returns>
        public object Clone() {
            return new Matrix((Array) Utils.Clone(m_elements), m_typeInfo.BuiltInType,
                (int[]) Utils.Clone(m_dimensions));
        }
