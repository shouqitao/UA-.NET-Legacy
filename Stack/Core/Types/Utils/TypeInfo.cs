...
namespace Opc.Ua {
    ...
    public class TypeInfo : IFormattable {
        ...
        public static bool IsValueType(BuiltInType builtInType) {
            ...
            if (builtInType == BuiltInType.DateTime || builtInType == BuiltInType.Guid ||
                builtInType == BuiltInType.StatusCode) {
                return true;
            }
        ...
        public static TypeInfo IsInstanceOfDataType(
            ...
            if (typeInfo.BuiltInType == BuiltInType.ByteString && typeInfo.ValueRank == ValueRanks.Scalar) {
                if (expectedValueRank == ValueRanks.OneOrMoreDimensions ||
        ...
        public static void CastArray(Array dst, BuiltInType dstType, Array src, BuiltInType srcType,
        ...
        public static Array CastArray(Array srcArray, BuiltInType srcType, BuiltInType dstType,
            CastArrayElementHandler convertor) {
            if (srcArray == null) {
                return null;
            }
        ...
        public static class Scalars {
            ...
            public static readonly TypeInfo ExpandedNodeId =
                new TypeInfo(BuiltInType.ExpandedNodeId, ValueRanks.Scalar);
            ...
            public static readonly TypeInfo ExtensionObject =
                new TypeInfo(BuiltInType.ExtensionObject, ValueRanks.Scalar);
            ...
            public static readonly TypeInfo DiagnosticInfo =
                new TypeInfo(BuiltInType.DiagnosticInfo, ValueRanks.Scalar);
        }
        ...
        public static class Arrays {
            ...
            /// </summary>
            public static readonly TypeInfo ExpandedNodeId =
                new TypeInfo(BuiltInType.ExpandedNodeId, ValueRanks.OneDimension);
            ...
            public static readonly TypeInfo QualifiedName =
                new TypeInfo(BuiltInType.QualifiedName, ValueRanks.OneDimension);

            /// <summary>
            /// A localized text string with an locale identifier.
            /// </summary>
            public static readonly TypeInfo LocalizedText =
                new TypeInfo(BuiltInType.LocalizedText, ValueRanks.OneDimension);

            /// <summary>
            /// An opaque object with a syntax that may be unknown to the receiver.
            /// </summary>
            public static readonly TypeInfo ExtensionObject =
                new TypeInfo(BuiltInType.ExtensionObject, ValueRanks.OneDimension);
            ...
            /// </summary>
            public static readonly TypeInfo DiagnosticInfo =
                new TypeInfo(BuiltInType.DiagnosticInfo, ValueRanks.OneDimension);
        }
