...
namespace Opc.Ua {
    ...
    public class ServiceResult {
        ...
        public ServiceResult(
            ...
            LocalizedText localizedText)
            :
            this(code, (symbolicId != null) ? symbolicId.Name : null,
                (symbolicId != null) ? symbolicId.Namespace : null, localizedText, (string) null,
                (ServiceResult) null) { }
        ...
        public ServiceResult(
            ...
            if (code.Code == innerResult.Code && symbolicId == null && localizedText == null &&
                additionalInfo == null) {
        ...
        public ServiceResult(StatusCode code, DiagnosticInfo diagnosticInfo, IList<string> stringTable) {
            ...
            if (diagnosticInfo != null) {
                ...
                if (!StatusCode.IsGood(diagnosticInfo.InnerStatusCode)) {
                    m_innerResult = new ServiceResult(diagnosticInfo.InnerStatusCode,
                        diagnosticInfo.InnerDiagnosticInfo, stringTable);
                }
            }
        }
        ...
        /// Initializes the object with a status code and a diagnostic info structure.
        /// </summary>
        public ServiceResult(StatusCode code, int index, DiagnosticInfoCollection diagnosticInfos,
