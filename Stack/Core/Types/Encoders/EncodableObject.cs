...
namespace Opc.Ua {
    ...
    public abstract class EncodeableObject : IEncodeable {
        ...
        /// </summary>
        public static ServiceResult ApplyDataEncoding(ServiceMessageContext context, QualifiedName dataEncoding,
            ref object value) {
            ...
            try {
                ...
                return ServiceResult.Create(e, StatusCodes.BadTypeMismatch,
