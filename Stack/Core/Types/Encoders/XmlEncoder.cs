...
namespace Opc.Ua {
    ...
    public class XmlEncoder : IEncoder, IDisposable {
        ...
        public void WriteExpandedNodeId(string fieldName, ExpandedNodeId value) {
            if (BeginField(fieldName, value == null, true)) {
                ...
                if (value != null) {
                    ...
                    StringBuilder buffer = new StringBuilder();
                    ExpandedNodeId.Format(buffer, value.Identifier, value.IdType, namespaceIndex, value.NamespaceUri,
                        serverIndex);
                    WriteString("Identifier", buffer.ToString());
                }
        ...
        public void WriteEnumerated(string fieldName, Enum value) {
            if (BeginField(fieldName, value == null, true)) {
                if (value != null) {
                    m_writer.WriteString(Utils.Format("{0}_{1}", value.ToString(),
                    ...
                    if (systemType != null) {
                        if (!systemType.IsInstanceOfType(value)) {
                            throw new ServiceResultException(
                                StatusCodes.BadEncodingError,
                                Utils.Format("Objects with type '{0}' are not allowed in the array being serialized.",
                                    systemType.FullName));
                        }
        ...
        public void WriteExtensionObjectBody(object body) {
            ...
            if (encodeable == null) {
                throw new ServiceResultException(
                    StatusCodes.BadEncodingError,
                    Utils.Format("Don't know how to encode extension object body with type '{0}'.",
        ...
        private void WriteMatrix(string fieldName, Matrix value) {
            if (BeginField(fieldName, value == null, true)) {
                ...
                if (value != null) {
                    ...
                    WriteVariantContents(value.Elements,
