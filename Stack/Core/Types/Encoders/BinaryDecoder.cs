...
namespace Opc.Ua {
    ...
    public class BinaryDecoder : IDecoder, IDisposable {
        ...
        /// </summary>
        public static IEncodeable DecodeMessage(Stream stream, System.Type expectedType,
        ...
        /// </summary>
        public static IEncodeable DecodeMessage(byte[] buffer, System.Type expectedType,
            ServiceMessageContext context) {
        ...
        private ExtensionObject ReadExtensionObject() {
            ...
            ExtensionObjectEncoding encoding =
                (ExtensionObjectEncoding) Enum.ToObject(typeof(ExtensionObjectEncoding), m_reader.ReadByte());
            ...
            if (encoding == ExtensionObjectEncoding.Xml) {
                ...
                if (systemType != null && extension.Body != null) {
                    ...
                    try {
                        ...
                        Utils.Trace("Could not decode known type {0}. Error={1}, Value={2}", systemType.FullName,
                            e.Message, element.OuterXml);
                    }
                }
            ...
            if (encodeable == null) {
                ...
                if (length == -1) {
                    throw new ServiceResultException(
                        StatusCodes.BadDecodingError,
                        Utils.Format("Cannot determine length of unknown extension object body with type '{0}'.",
                            extension.TypeId));
                }
                    ...
                    if ((encodingByte & (byte) VariantArrayEncodingBits.ArrayDimensions) != 0) {
                        ...
                        if (matrixLength != length) {
                            throw new ServiceResultException(StatusCodes.BadDecodingError,
                                "ArrayDimensions does not match with the ArrayLength in Variant object.");
                        }
