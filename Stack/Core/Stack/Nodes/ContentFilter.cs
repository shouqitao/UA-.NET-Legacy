...
namespace Opc.Ua {
    ...
    public partial class ContentFilter : IFormattable {
        ...
        public class ElementResult {
            ...
            /// <param name="stringTable">The string table.</param>
            /// <returns></returns>
            public ContentFilterElementResult ToContentFilterElementResult(DiagnosticsMasks diagnosticsMasks,
                ...
                foreach (ServiceResult operandResult in m_operandResults) {
                    if (ServiceResult.IsGood(operandResult)) {
                        ...
                        result.OperandDiagnosticInfos.Add(new DiagnosticInfo(operandResult, diagnosticsMasks, false,
                            stringTable));
                    }
                }
