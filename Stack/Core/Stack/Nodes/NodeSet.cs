...
namespace Opc.Ua {
    ...
    public partial class NodeSet : IEnumerable<Node> {
        ...
        private void TranslateArrayValue(Array array, BuiltInType elementType, NamespaceTable namespaceUris,
        ...
        /// <param name="namespaceUris">The namespace URIs.</param>
        /// <param name="serverUris">The server URIs.</param>
        public void AddReference(Node node, ReferenceNode referenceToExport, NamespaceTable namespaceUris,
            StringTable serverUris) {
            ReferenceNode reference = new ReferenceNode();
        ...
        internal StringCollection NamespaceUris {
            get { return new StringCollection(m_namespaceUris.ToArray()); }
        ...
        internal StringCollection ServerUris {
            get { return new StringCollection(m_serverUris.ToArray()); }
        ...
        internal NodeCollection Nodes {
            get { return new NodeCollection(m_nodes.Values); }
