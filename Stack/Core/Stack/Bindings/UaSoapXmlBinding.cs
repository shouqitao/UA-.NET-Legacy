    ...
    public class UaSoapXmlBinding : BaseBinding {
        ...
        public UaSoapXmlBinding(
            ...
            if (description != null && description.SecurityMode != MessageSecurityMode.None) {
                SymmetricSecurityBindingElement bootstrap =
                ...
                m_security =
                    (SymmetricSecurityBindingElement) SecurityBindingElement.CreateSecureConversationBindingElement(
                        bootstrap, true);
                ...
                m_security.MessageSecurityVersion = MessageSecurityVersion
                    .WSSecurity11WSTrust13WSSecureConversation13WSSecurityPolicy12BasicSecurityProfile10;
