    ...
    public class JsonEncoder : IEncoder, IDisposable {
        ...
        public void WriteInt64(string fieldName, long value) {
            WriteSimpleField(fieldName, value.ToString(CultureInfo.InvariantCulture),
                (value > Int32.MaxValue || value < Int32.MinValue));
        }
        ...
        public void WriteDateTime(string fieldName, DateTime value) {
            if (value == DateTime.MinValue) {
                ...
                WriteSimpleField(fieldName, XmlConvert.ToString(value, XmlDateTimeSerializationMode.RoundtripKind),
                    true);
            }
        }
        ...
        public void WriteVariant(string fieldName, Variant value) {
            bool isNull = (value.TypeInfo == null || value.TypeInfo.BuiltInType == BuiltInType.Null ||
                           value.Value == null);
        ...
        private void WriteMatrix(string fieldName, Matrix value) {
            PushStructure(fieldName);
            WriteVariant("Matrix",
                new Variant(value.Elements, new TypeInfo(value.TypeInfo.BuiltInType, ValueRanks.OneDimension)));
