...
namespace Opc.Ua.Publisher {
    [CollectionDataContract(Name = "ListOfAmqpConnectionConfigurations", Namespace = Namespaces.OpcUaConfig,
        ItemName = "AmqpConnectionConfiguration")]
    ...
    public class AmqpConnection {
        ...
        protected bool SendOne(ArraySegment<byte> body) {
            ...
            Message message = new Message() {BodySection = new Data() {Binary = istrm.ToArray()}};
